                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body row">
                                                        ...
                                                        <div class="col-md-12 social-btn-wrp">
                                                            <div class="row">
                                                                <a href="{{ route('user.facebookLogin') }}" class="social-btn fb-btn"><svg
                                                                ...
                                                                <a href="{{ route('user.twitterLogin') }}" class="social-btn twtr-btn"><svg
                                                                ...
                                                                <a href="{{ route('user.googleLogin') }}" class="social-btn google-btn"><svg
                                                                ...
                                                                <a href="{{ route('user.linkedinLogin') }}" class="social-btn lnkdn-btn"><svg
                                                                        width="15" height="15" viewBox="0 0 15 15"
                                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
