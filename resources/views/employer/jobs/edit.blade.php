...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Job Post Edit</h6>
                    <form method="POST" action="{{ route('employer.job-posts.update', $jobPost->id) }}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="title" value="{{ old('title', $jobPost->title) }}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="industry" value="{{ old('industry', $jobPost->industry) }}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="email"
                                        ...
                                        name="email" value="{{ old('email', $jobPost->email) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type"
                                        ...
                                        <option value="fullTime"
                                            {{ old('type', $jobPost->type) == 'fullTime' ? 'selected' : '' }}>
                                            Full Time
                                        </option>
                                        <option value="fresher"
                                            {{ old('type', $jobPost->type) == 'fresher' ? 'selected' : '' }}>
                                            Fresher
                                        </option>
                                        <option value="internship"
                                            {{ old('type', $jobPost->type) == 'internship' ? 'selected' : '' }}>
                                            Internship
                                        </option>
                                        <option value="contract"
                                            {{ old('type', $jobPost->type) == 'contract' ? 'selected' : '' }}>
                                            Contract
                                        </option>
                                        <option value="temporary"
                                            {{ old('type', $jobPost->type) == 'temporary' ? 'selected' : '' }}>
                                            Temporary
                                        </option>
                                        <option value="partTime"
                                            {{ old('type', $jobPost->type) == 'partTime' ? 'selected' : '' }}>
                                            Part Time
                                        </option>
                                    </select>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control @if ($errors->has('description')) is-invalid @endif" cols="30"
                                        rows="5" required>{{ old('description', $jobPost->description) }}</textarea>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @if ($errors->has('skills')) is-invalid @endif"
                                        name="skills" id="skills" value="{{ @old('skills', $jobPost->skills) }}" />
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="city" value="{{ old('city', $jobPost->city) }}" placeholder="Enter City"
                                        required>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="town" value="{{ old('town', $jobPost->town) }}"
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="division" value="{{ old('division', $jobPost->division) }}"
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="country" value="{{ old('country', $jobPost->country) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="residentType" required
                                        ...
                                        <option value="resident"
                                            {{ old('residentType', $jobPost->residentType) == 'resident' ? 'selected' : '' }}>
                                            Resident
                                        </option>
                                        <option value="nonResident"
                                            {{ old('residentType', $jobPost->residentType) == 'nonResident' ? 'selected' : '' }}>
                                            Non - Resident
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex">
                                        <input type="number"
                                            ...
                                            name="salaryFrom" value="{{ old('salaryFrom', $jobPost->salaryFrom) }}"
                                        ...
                                        <input type="number"
                                            ...
                                            name="salaryTo" value="{{ old('salaryTo', $jobPost->salaryTo) }}"
                                            placeholder="Enter salaryTo" required>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="schedule_date" id="scheduleDate"
                                        value="{{ old('schedule_date', date('d-m-Y', strtotime($jobPost->schedule_date))) }}"
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('deadline', date('d-m-Y', strtotime($jobPost->deadline))) }}"
