...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Employer Edit</h6>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="name" value="{{ old('name', $employer->name) }}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="company_name" value="{{ old('company_name', $employer->company_name) }}"
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" class="form-control @if ($errors->has('address')) is-invalid @endif" cols="30"
                                        rows="5" required>{{ old('address', $employer->address) }}</textarea>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @if ($errors->has('about')) is-invalid @endif" name="about"
                                        id="tinymceExample" rows="10">{{ old('about', $employer->about) }}</textarea>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="url"
                                        ...
                                        name="instagram" value="{{ old('instagram', $employer->instagram) }}"
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="url"
                                        ...
                                        name="linkedin" value="{{ old('linkedin', $employer->linkedin) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    @if (isset($employer->image))
                                        <img src="{{ asset('storage/' . $employer->image) }}"
                                            alt="{{ $employer->company_name }}" width="350"
